...
INSERT INTO `users` (`id`, `username`, `email`, `phone`, `bio`, `hashed_password`, `firstname`, `lastname`, `date_of_birth`, `avatar_url`, `created_at`, `updated_at`) VALUES
...
ALTER TABLE `comments`
    ADD PRIMARY KEY (`id`),
    ADD KEY `fk_comments_authorId_users_id` (`author_id`);
...
ALTER TABLE `follow`
    ADD PRIMARY KEY (`id`),
    ADD KEY `fk_follow_followerUserId_users_id` (`follower_user_id`),
    ADD KEY `fk_follow_followedUserId_users_id` (`followed_user_id`);
...
ALTER TABLE `posts`
    ADD PRIMARY KEY (`id`),
    ADD KEY `fk_posts_authorId_users_id` (`author_id`);
...
alter table comments
    add post_id int not null after id;

alter table comments
    add constraint fk_comments_postId_posts_id
